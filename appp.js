        ...
        if (marca) {
          ...
          if (modelo) {
            ...
            const html = `
              ...
              <div class="container" style="width: 75vw;"><img style="width: 100%; max-width: 400px; max-height: 400px;" src="${modelo.imagen}" alt="${marcaSeleccionada} ${modeloSeleccionado}"></div>
